...
function UpdateSubjectNotes() {
  ...
  const handleDeletePDF = async (subjectId, urlIndex, link) => {
    try {
      ...
      setSubjectData((prevData) => ({
        ...prevData,
        subjectnotesUrls: prevData.subjectnotesUrls.filter(
  ...
  const handleSubjectPdfUpload = (e) => {
    if (
      ...
      subjectfile.length < 4 &&
      subjectData.subjectnotesUrls.length < 3
    ) {
      ...
      setError("You can upload up to 3 files only. Or provide a file");
    }
  };
      ...
      <div className="flex flex-col ">
        ...
        <div className="flex flex-col gap-10">
          ...
          <h1 className="text-center text-3xl">
            ...
            <span className="text-xs opacity-[0.4]"> Update Subject Notes</span>
          </h1>
            </div>
        </div>
          ...
          <div className="flex items-center p-3 justify-center">
            <label htmlFor="pdfdescription" className="text-xs sm:text-lg">
              Subject Notes Description
            </label>
            <input
              type="text"
              value={subjectData.pdfdescription || ""}
          ...
          <div>
            {subjectData.subjectnotesUrls.map((url, urlIndex) => (
              <div
...
export default UpdateSubjectNotes;   
